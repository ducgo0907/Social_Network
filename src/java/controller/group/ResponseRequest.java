 ...
 * @author ngoqu
 */
@WebServlet(name = "ResponseRequest", urlPatterns = {"/responserequest"})
public class ResponseRequest extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            switch (action) {
                case "accept":
                    gd.acceptMember(userId, groupId);
                    break;
                case "refuse":
                    gd.refuseMember(userId, groupId);
                    break;
                default:
        ...
        request.getRequestDispatcher("showgroup?id=" + groupId_raw).forward(request, response);
    }
